    ...
    return (
        <nav className="h-14 shrink-0 z-40 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800/50 px-4 shadow-2xl flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-3">
                ...
                {hasConfig && (
                    <div className="flex items-center gap-1.5 bg-slate-950/50 p-1 rounded-xl border border-slate-800 h-11 shrink-0">
                        {onOpenEditorSettings && (
                            <Button
                                variant="secondary"
                                onClick={onOpenEditorSettings}
                                icon="FolderUser"
                                className="h-9 px-3 text-xs rounded-lg shadow-none border-slate-700/60"
                        ...
                        {onClearConfig && (
                            <Button
                                ...
                                icon="XCircle"
                                className="h-9 px-3 text-xs rounded-lg shadow-none bg-rose-600 hover:bg-rose-500 text-white font-bold"
                                title="Clear Config"
                            >
                                Clear
                            </Button>
